      ...
      <aside>
         <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	 ...
              	 <p class="centered"><a href="goToDashboard.htm"><img src="resources/assets1/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
              	  <h5 class="centered">${sessionScope.emailId}</h5>
              	  	
              	  <li class="mt">
                      <a class="active" href="viewjob.htm">
                   ...
                   <li class="mt">
                      <a class="active" href="addskills.htm">
                          <i class="fa fa-dashboard"></i>
                  ...
                  <li class="mt">
                      <a class="active" href="viewapplications.htm">
                          <i class="fa fa-dashboard"></i>
				  ...
				  <li class="mt">
                      <a class="active" href="addcareer.htm">
                          <i class="fa fa-dashboard"></i>
				  ...
				  <li class="mt">
                      <a class="active" href="addeducation.htm">
                          <i class="fa fa-dashboard"></i>
